                    ...
                    <a href="{{ Auth::user()->usertype === 'admin' ? route('admin.dashboard') : route('user.dashboard') }}"> 
                     ...
                     <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        ...
                        {{-- Admin Links --}}
                         ...
                         <x-nav-link href="{{ url('/tasks/index') }}" :active="request()->is('tasks/*')">
                             {{ __('Tasks') }}
                        </x-nav-link> 
                        
                        <x-nav-link href="{{ url('/admin/category') }}" :active="request()->is('admin/category*')"> 
                            {{ __('Categories') }} 
                        </x-nav-link>
                        ...
                        <x-nav-link href="{{ url('/admin/user') }}" :active="request()->is('admin/user*')">
                            ...
                            <x-nav-link href="{{ url('/user/profile') }}" :active="request()->is('user/profile*')"> {{ __('My Profile') }} 
